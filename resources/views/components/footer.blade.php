<footer class="bg-body-tertiary text-center mt-auto w-100">
  <div class="container p-4 pb-0">
    <div class="row align-items-center">
      ...
      <div class="col-12 col-md-6 border-start-md">
        ...
        <a href="{{ route('become.revisor') }}" class="btn btn-success btn-lg shadow-sm">
  ...
  <div class="text-center p-3 mt-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2026 Copyright:
    <a class="text-body fw-bold" href="https://mdbootstrap.com/">Presto.it</a>
  </div>
</footer>